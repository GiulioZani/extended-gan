...
class BaseGanLightning(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        generator_optimizer = SAM(
            self.generator.parameters(), t.optim.SGD, lr=0.01, momentum=0.9
        )
        ...
        frame_discriminator_optimizer = SAM(
            self.frame_discriminator.parameters(), t.optim.SGD, lr=0.01, momentum=0.9
        )
        temporal_discriminator_optimizer = SAM(
            self.temporal_discriminator.parameters(), t.optim.SGD, lr=0.01, momentum=0.9
        )
        return (
            [
                generator_optimizer,
