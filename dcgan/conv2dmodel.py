...
class ProbablisticConvGenerator(nn.Module):
    def __init__(self, params):
        ...
        self.layers = nn.Sequential(
            ...
            ConvBlock(params["nc"] * 8* mlp, params["nc"] * 4 * mlp, 4, padding="same"),
    ...
    def forward(self, x, noiseVariance = 0.001):
        ...
        # noise is a random
        noise_matrix_w_h = 12
        noise = t.randn( self.params['nc'], 1, noise_matrix_w_h)
        
        x_concat = t.zeros((x.shape[0], x.shape[1], x.shape[2]+ 1, x.shape[3]+ noise_matrix_w_h))
    ...
    def __init__(self, params):
        ...
        self.layers = nn.Sequential(
            *[
                ...
                ConvBlock(
                    params['seq_len_in'] + params['seq_len_out'],
                    ndf,
                    kernel_size=4,
                    stride=2,
                    bias=True,
