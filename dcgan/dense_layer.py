...
class AVGPool3DConcatDenseLayer(nn.Module):
    ...
    def __init__(self, params, c_hidden, depth, imsize, hf , num_layers=4, concat_full_image=False):
...
class AVGPoolConcatDenseLayer(nn.Module):
    ...
    def __init__(self, params, c_hidden, imsize, hf , num_layers=4, concat_full_image=False):
